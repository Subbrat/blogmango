...
?>
        <li><a
                href="blog-post-details.php?bid=<?php echo htmlentities($result['pid'])?>"><?php echo htmlentities($result['posttitle']);?></a>
        </li>
        <?php } ?>
    </ul>
    <hr ?>
...
?>
        <li>
            <a
                href="category-posts.php?catid=<?php echo htmlentities($row['catid'])?>&&catname=<?php echo htmlentities($row['CategoryName']);?>"><?php echo htmlentities($row['CategoryName']);?>
                (<?php echo htmlentities($row['totalpost']);?>)</a>
        </li>
        <?php } ?>
    </ul>
</div>