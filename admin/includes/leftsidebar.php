            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft s6-text-black">
                    <!--- Sidemenu -->
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i
                                        class="mdi mdi-format-list-bulleted"></i> <span> Sub-admins </span> <span
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i
                                        class="mdi mdi-format-list-bulleted"></i> <span>Sub Category </span> <span
                                        class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i
                                        class="mdi mdi-format-list-bulleted"></i> <span> Posts (Blog) </span> <span
                                        class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i
                                        class="mdi mdi-format-list-bulleted"></i> <span> Pages </span> <span
                                        class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i
                                        class="mdi mdi-format-list-bulleted"></i> <span> Comments </span> <span
                                        class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                            ...
                            <li class="has_sub">
                                <a href="subscribers.php" class="waves-effect"><i
                                        class="mdi mdi-format-list-bulleted"></i> <span> Subscribers </span> </a>
                            </li>
                            <li class="has_sub">
                                <a href="website-settings.php" class="waves-effect"><i class="ti-settings m-r-5"></i>
